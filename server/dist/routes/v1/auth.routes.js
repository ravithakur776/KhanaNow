...
import { registerSchema, loginSchema, forgotPasswordSchema, resetPasswordSchema, verifyOTPSchema, resendVerificationSchema, } from '../../validators/auth.validator.js';
const router = Router();
...
router.post('/verify-email', validateRequest(verifyOTPSchema), (req, res, next) => authController.verifyEmail(req, res, next));
router.post('/resend-verification', validateRequest(resendVerificationSchema), (req, res, next) => authController.resendVerification(req, res, next));
