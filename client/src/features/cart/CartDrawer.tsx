...
import { useValidateCouponMutation } from '../../services/couponService';
          ...
          {items.length === 0 ? (
            <div className="flex flex-1 flex-col items-center justify-center p-8 text-center">
              ...
              <p className="text-xs text-muted-foreground mb-6">
                Good food is always waiting for you. Add dishes from your favorite kitchen!
              </p>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="space-y-4">
                {items.map((item) => (
                  <div
                    key={item.cartItemId}
                    className="flex items-center justify-between gap-4 p-3.5 rounded-2xl border border-border/80 bg-background/50"
                  >
              ...
              <div className="text-right">
                ...
                >
                  Open Full Cart Page <ExternalLink className="h-3.5 w-3.5" />
                </Link>
              </div>
